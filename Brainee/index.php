...
?>
    <div class="container">
      ...
      <div class="jumbotron p-3 p-md-5 text-white rounded bg-destaque">
      ...
      <div class="row mb-2">
        <div class="col-md-9">
          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            ...
            <a href="blog/como-tirar-sua-startup-do-papel.php"><img class="imagemPost img-fluid" src="img/meeting.jpg"></a>
              <h3 class="mb-0">
...
Pensando nisso, a Brainee elaborou esse conteúdo. Então aproveite e leia até o final e veja como funciona, <br/> onde encontrar, as vantagens e se torne expert no assunto.</p>
          ...
          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            ...
            <a href="blog/como-ter-um-mindset-empreendedor.php">
              ...
              <a href="blog/como-ter-um-mindset-empreendedor.php">Continue lendo...</a>
            </div>
          </div>
